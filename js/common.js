document.addEventListener("DOMContentLoaded", function() {
  ...
  SimpleJekyllSearch({
    ...
    searchResultTemplate: '<div class="search-results__item"><a href="{url}" class="search-results__image" style="background-image: url({image})"></a> <a href="{url}" class="search-results__link"><div class="search-results-title">{title}</div></a></div>',
